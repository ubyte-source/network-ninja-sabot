...
ENV STARTUP_COMMAND_RUN_TFTP="/usr/bin/sudo /usr/sbin/in.tftpd --ipv4 --foreground --user sabot --address 0.0.0.0:69 --secure /var/tftpboot --blocksize 1380 --port-range 40000:55000"
